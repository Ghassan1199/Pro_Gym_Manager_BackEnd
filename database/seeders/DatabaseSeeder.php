...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        admin::factory(10)->create()->each(function ($admin) use ($exe) {
            gym::factory(1)->create(['admin_id' => $admin->id,])->each(function ($gym) use ($exe) {
                coach::factory(3)->create(['gym_id' => $gym->id])->each(function ($coach) use ($gym, $exe) {
